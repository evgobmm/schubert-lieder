...
//   node planning/scripts/removed-queue.js <runId|journal.jsonl> <outFile.json>
...
fs.writeFileSync(out, JSON.stringify({ all: queue.length, to_verify: noSupport }, null, 1));
