# D 59 «Verklärung» — топ-5

Гердер по Александру Поупу («The dying Christian to his soul»), 1813. Необычно широкий для ранней песни пул.

| # | Запись | year | videoId | Обоснование года / источник |
|---|--------|------|---------|------------------------------|
| 1 | Fischer-Dieskau — Moore | 1969 | o3V87DhBZms | DG «Sämtliche Lieder» (1966–72); конвенция проекта 1969 |
...
**Отклонены**: Keenlyside — Martineau (J2yxyOVshvs, альбом не идентифицирован ни по реестру, ни по MB-релизам); Noordewier-Reddingius — van der Horst (историческая голландская запись, ролик не найден); Boog — Eisenlohr (Naxos, ролик D 59 не найден); Ian Partridge, Baroque Concentus и пр. — без данных о певце/непрофильные.
