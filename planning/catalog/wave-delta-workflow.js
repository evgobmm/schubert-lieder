...
const S_FABLE = { type: 'object', properties: { d: { type: 'string' }, ok: { type: 'boolean' }, n_changes: { type: 'number' }, removed: { type: 'array', maxItems: 20, items: { type: 'object', properties: { what: { type: 'string', maxLength: 500 }, why: { type: 'string', maxLength: 500 } }, required: ['what', 'why'] } }, flags: { type: 'array', maxItems: 8, items: { type: 'string', maxLength: 500 } }, tool_calls: { type: 'number' } }, required: ['d', 'ok', 'n_changes', 'removed', 'tool_calls'] }
...
const S_FIX = { type: 'object', properties: { d: { type: 'string' }, ok: { type: 'boolean' }, applied: { type: 'number' }, rejected: { type: 'array', maxItems: 10, items: { type: 'string', maxLength: 500 } }, tool_calls: { type: 'number' } }, required: ['d', 'ok', 'applied', 'tool_calls'] }
