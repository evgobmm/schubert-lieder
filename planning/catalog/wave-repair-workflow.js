...
const deltaPrompt = (s) => `Ты — контролёр сохранности и прослеживаемости перед публикацией. ${CONV} Инструмент — только Read бандла (одна-две части), больше ничего: ни grep, ни скриптов, ни других файлов; после чтения сразу отвечай.
