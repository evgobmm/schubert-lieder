# Состояние конвейера YouTube-записей (пилот: 30 песен 1824–1825)

Обновлять после каждой волны. По этому файлу новая сессия продолжает с места обрыва.
...
- Волна 3 (medium): 834, 837, 838, 851, 862
- Волна 4 (medium/rare): 808, 833, 832, 846, 856
- Волна 5 (rare): 805, 830, 831, 843, 854
- Волна 6 (rare): 855, 857/1, 857/2, 860, 861
